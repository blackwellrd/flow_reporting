---
title: "Flow Reporting using RMarkdown"
...
pct_current_month_baseline_wemwbs <- number_current_month_baseline_wemwbs / denominator
pct_current_month_loneliness_question <- number_current_month_loneliness_question / denominator
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q1_baseline_wemwbs <- number_Q1_baseline_wemwbs / denominator
  pct_Q1_loneliness_question <- number_Q1_loneliness_question / denominator
} else {
  denominator <- NA
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q2_baseline_wemwbs <- number_Q2_baseline_wemwbs / denominator
  pct_Q2_loneliness_question <- number_Q2_loneliness_question / denominator
} else {
  denominator <- NA
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q3_baseline_wemwbs <- number_Q3_baseline_wemwbs / denominator
  pct_Q3_loneliness_question <- number_Q3_loneliness_question / denominator
} else {
  denominator <- NA
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q4_baseline_wemwbs <- number_Q4_baseline_wemwbs / denominator
  pct_Q4_loneliness_question <- number_Q4_loneliness_question / denominator
} else {
  denominator <- NA
...
pct_YTD_baseline_wemwbs <- number_YTD_baseline_wemwbs / denominator
pct_YTD_loneliness_question <- number_YTD_loneliness_question / denominator
...
pct_current_month_exit_wemwbs <- number_current_month_exit_wemwbs / denominator
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q1_exit_wemwbs <- number_Q1_exit_wemwbs / denominator
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q2_exit_wemwbs <- number_Q2_exit_wemwbs / denominator
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q3_exit_wemwbs <- number_Q3_exit_wemwbs / denominator
...
if(dt_current_month >= dt_year_start){
  ...
  pct_Q4_exit_wemwbs <- number_Q4_exit_wemwbs / denominator
...
pct_YTD_exit_wemwbs <- number_YTD_exit_wemwbs / denominator
...
df_RPT_03_process_kpis <- data.frame(metric = c('80% of new clients has a wemwebs baseline score',
                              ...
                              current_month = c(pct_current_month_baseline_wemwbs,
                                                pct_current_month_exit_wemwbs,
                                                pct_current_month_loneliness_question,
                                                pct_current_month_exit_loneliness),
                              q1 = c(pct_Q1_baseline_wemwbs,
                                     pct_Q1_exit_wemwbs,
                                     pct_Q1_loneliness_question,
                                     pct_Q1_exit_loneliness),
                              q2 = c(pct_Q2_baseline_wemwbs,
                                     pct_Q2_exit_wemwbs,
                                     pct_Q2_loneliness_question,
                                     pct_Q2_exit_loneliness),
                              q3 = c(pct_Q3_baseline_wemwbs,
                                     pct_Q3_exit_wemwbs,
                                     pct_Q3_loneliness_question,
                                     pct_Q3_exit_loneliness),
                              q4 = c(pct_Q4_baseline_wemwbs,
                                     pct_Q4_exit_wemwbs,
                                     pct_Q4_loneliness_question,
                                     pct_Q4_exit_loneliness),
                              ytd = c(pct_YTD_baseline_wemwbs,
                                     pct_YTD_exit_wemwbs,
                                     pct_YTD_loneliness_question,
                                     pct_YTD_exit_loneliness))
...
metrics <- c('Number of wider beneficiaries', 'Clients who declined', '***Total current open cases',
...
tbl <- flextable(df_RPT_03_process_kpis %>% mutate(across(.cols = 2:7, .fns = function(x){round(x*100, 0)}))) %>%
  set_header_labels(
    metric = 'Metric',
    current_month = format(dt_current_month, '%b-%y'),
    q1 = 'Q1',
